import {slideData} from "./slider-data.js";
...
export default function createSliderItemMarkup(data){
...
function setData(markUp){
    slideWrap.innerHTML = markUp.join(' ')
}

let itemWidth = document.querySelector(".slide").clientWidth;
let gap = 18;
